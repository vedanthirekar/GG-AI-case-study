...
export const START_HERE = {
  ...
  firm: [
    ...
    { icon: 'sparkle', title: 'Work with Verity AI', body: 'The AI shows its evidence and its uncertainty. Where a figure is genuinely ambiguous it offers you a choice instead of a guess.', to: '/returns' },
  ],
}
...
export const FAQ = [
  ...
  { id: 'q-ambiguous', audience: 'firm', cat: 'Verity AI', q: 'What happens when the AI isn’t sure?',
  ...
  { id: 'q-correct', audience: 'firm', cat: 'Verity AI', q: 'How do I correct the AI without redoing everything?',
  ...
  { id: 'q-confidence', audience: 'firm', cat: 'Verity AI', q: 'What does the confidence percentage mean?',
...
export const GUIDES = [
  { id: 'traceability', audience: 'all', icon: 'compass', title: 'How traceability works',
    body: 'Every figure on a return carries a link back to the document it came from, the exact region of that document, and any calculation applied along the way. Nothing on a Verity return is an unattributed number — if you can see it, you can see where it came from.' },
  { id: 'ai', audience: 'all', icon: 'sparkle', title: 'How Verity AI decides',
...
export const SUPPORT = [
  ...
  { icon: 'mail', title: 'Email support', body: 'support@verity.tax — for accounts, access and billing.', audience: 'all' },
...
export const PAGE_HELP = [
  { match: '/dashboard', title: 'Your dashboard', points: [
    ...
    'Toggle My work / Whole firm to switch between your queue and the practice’s.',
  ...
  { match: '/documents', title: 'Documents', points: [
    'Search and the category facets narrow hundreds of files fast.',
    'Selecting a document keeps the list beside it, so you never lose your place.',
  ], faq: ['q-search', 'q-lost'] },
